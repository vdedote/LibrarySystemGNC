...
<body onload="SetDate();">
	...
	<div class="container-width" style="margin-top: 50px;">
			...
			<div class="container-fluid" style="margin-top: 20px;">
			  <div class="row">
			    <div class="col-md-7" >
					    ...
					    <h3>Books:</h3>
			<?php	
				if ($ErrorMessage === "Show Notif") 
				{
					 echo "<div class='container-fluid'>

						  <div class='row'>
						    <div class='col-md-7'></div>
							    <div id='NotifForFail' class='col-md-7'>
							    		<div class='alert alert-danger alert-dismissable fade in'>
					    					<a href='#'' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
					    					<strong>Notice:</strong>The Student already borrowed 3 books.
					  					</div>
							    </div>
						    <div class='col-md-7'></div>
						  </div>
			...
			<?php	
				if ($ErrorMessage === "No book Available!") 
				{
					 echo "<div class='container-fluid'>
						  ...
						  <div class='row'>
						    <div class='col-md-7'></div>
							    <div id='NotifForFail' class='col-md-7'>
							    		<div class='alert alert-danger alert-dismissable fade in'>
					    					<a href='#'' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
					    					<strong>Notice:</strong>Book Unavailable as of this moment.
					  					</div>
							    </div>
						    <div class='col-md-7'></div>
						  </div>
			...
			?>	
					    <label>A single student can only borrow 3 books</label>
					...
					?>
							<tbody>
								<tr>
									...
									<td style="cursor: pointer;" align="center"> <?php echo $row['BookCode'];?></td>
					...
					<div class="col-md-2">
						<form method="POST">
							<div class="input-group">
					    		...
					    		<input id="myInput"  onkeyup="myFunction()" type="text" class="form-control" name="Position" placeholder="Title/Author/BookCode">
							</div>
						</form>
								...
								<input style="background-image: url(book.png);
											...
											<!--  <a href="bookborrowing.php">borrow</a> -->
					</div>
			</div>
		</div>
        	...
        	<table>
        		...
        		<tbody>
        			...
        			<tr>
        				...
        				<td><input id="txt1" style="padding: 5px 5px 5px 5px; width: 300px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxlength="9" min = "0" type="number" name="Transac" required="true"></td>
        			</tr>
        			<tr>
        		...
        		<!-- 	<tr>
        			...
        			<tr>
        				...
        				<td><input style="cursor: not-allowed;" type="text" style="padding: 5px 5px 5px 5px; width: 300px;" pattern="[A-Z a-z+{}]{3,20}$" name="Remarks" value="Borrowed" readonly="true"></td>
        			</tr>
        			<tr>
        				<td></td>
        				<td>
        	...
        	<table>
        		...
        		<tbody>
        			...
        			<!-- <tr>
        				...
        				<td><select style="cursor: pointer;" name="Category" class="form-control">
					      		<option name= "CSIT">CSIT</option>
					      		<option name= "BSHRM">BSHRM</option>
					      		<option name= "ENGINEERING">ENGINEERING</option>
					      		<option name= "PHARMACY">PHARMACY</option>
					      		<option name= "OTHERS">OTHERS</option>
					      	</select></td>
        			</tr> -->
        			<tr>
        				<td><label>Book Code:</label></td>
        				<td><input type="text" id="sessionNo" name="BookCode" onkeypress="return isNumberKey(event)" maxlength="12" /></td>
        			</tr>
        			<tr>
        				<td><label>Book Title:</label></td>
        				<td><input id="txt2" style="padding: 5px 5px 5px 5px; width: 300px;" pattern="[A-Z a-z+{}]{3,100}$" type="text" name="BookTitle" placeholder="Title" required=""></td>
        			...
        			<tr>
        				<td><label>Remarks:</label></td>
        				<td><input type="text" style="padding: 5px 5px 5px 5px; width: 300px;" pattern="[A-Z a-z+{}]{3,20}$" name="Remarks"></td>
        			</tr>
        			<tr>
        				<td></td>
        				<td>
