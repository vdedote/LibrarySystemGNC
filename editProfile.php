<?php 
	...
	elseif (($_SESSION['type'] == 'Student'))
	{
		...
		if ((isset($_POST['Lname'])&&($_POST['Position'])!= 'Student'))
			{
...
<form method="POST">
        	<table>
        		...
        		?>
        			<tr>
						<td> </td>	
						 <td> <div class="alert alert-danger alert-dismissable fade in" id="error">
		...
		?>	   
        			...
        			<tr>
        				...
        				<td><input id="txt2" style="background-image: url(user.png); background-repeat: no-repeat; background-size: 25px 25px;
					         background-position: 2px 5px;
					         padding: 5px 5px 5px 30px; width: 300px;" pattern="[A-Z a-z+{}]{3,100}$" type="text" name="Lname" placeholder="Last Name" value="<?php  echo $lname;?>"  required=""></td>
        			</tr>
        			<tr>
        				<td><label>First Name:</label></td>
        				<td><input type="text" style="background-image: url(user.png); background-repeat: no-repeat; background-size: 25px 25px;
					         background-position: 2px 5px;
					         padding: 5px 5px 5px 30px;width: 300px;" pattern="[A-Z a-z+{}]{3,20}$" name="fName" placeholder="First Name" value="<?php  echo $fname;?>"  required=""></td>
        			</tr>
        			<tr>
        				<td><label>Middle Name:</label></td>
        				<td><input type="text" style="background-image: url(user.png); background-repeat: no-repeat; background-size: 25px 25px;
					         background-position: 2px 5px;
					         padding: 5px 5px 5px 30px;width: 300px;" name="mName" value="<?php  echo $mname;?>"  placeholder="Middle Name" required=""></td>
        			</tr>
<?php 
		if($_SESSION['type']== 'Student')
		{
?>
        			<tr>
						...
						background-position: 2px 5px;
						padding: 5px 5px 5px 30px;width: 300px;" class="form-control" name="Course" value ="<?php echo $crse;?>" >
        			...
        			<tr>
        				...
        				<td>
					      	<input type="text" style=" background-size: 25px 25px;
					         background-position: 2px 5px;
					         padding: 5px 5px 5px 30px;width: 300px;" name="Year" class="form-control" value="<?php  echo $year1;?>" >
        ...
        ?>
        			...
        			<tr>
					       ...
					       <td>  <textarea
					         style="background-image: url(address.png); background-repeat: no-repeat; background-size: 25px 25px; background-position: 2px 5px; padding: 5px 5px 5px 30px;width: 300px;"  class="form-control" id="Address" name = "address"><?php  echo $addrs;?></textarea>
					        </td>
...
?>		
					...
					<tr>
						...
						<td><label>Gender:</label></td>
					     	<td><input name="sex" id="Male" type="radio" required value="Male"<?php echo($gen == "Male")?'checked': '' ?> >Male
				     	
				     		<input name="sex" id="Female" type="radio" required value="Female" <?php echo($gen == "Female")?'checked': ''?> >Female
				     		</td>
